    ...
    content:
      ...
      text: |
        ...
        **지도교수:** 유은종 교수 (eunjongyu@hanyang.ac.kr)
        ...
        <tr><td style="padding:0.5rem;text-align:center;">이부용</td><td style="padding:0.5rem;text-align:center;">건축공학부</td><td style="padding:0.5rem;text-align:center;">석사과정</td><td style="padding:0.5rem;text-
        </tbody>
        </table>
        </div>
    design:
