  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        최근 빈번해진 지진 발생으로 인해 재난 대비의 중요성이 그 어느 때보다 강조되고 있습니다. 우리 사업단은 지진 재난으로부터 안전한 사회를 만들기 위해 현장 중심의 실무 능력을 갖춘 전문 인력을 양성하고 있습니다.
...
<div style="text-align: center; display: flex; justify-content: center; gap: 20px; flex-wrap: wrap; margin-top: 20px;">
  <img src="/uploads/협약사진1.jpg" alt="사진1" style="max-width: 45%; height: auto; border-radius: 8px;">
  <img src="/uploads/협약서.pdf" alt="사진2" style="max-width: 45%; height: auto; border-radius: 8px;">
</div>
    design:
      spacing:
